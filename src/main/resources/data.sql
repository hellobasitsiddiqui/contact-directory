...
INSERT INTO contacts (first_name, last_name, email, phone, company, favorite, created_at, updated_at, version)
VALUES ('Jane', 'Doe', 'jane.doe@example.com', '+1 (555) 123-4567', 'Acme Ltd', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

INSERT INTO contacts (first_name, last_name, email, phone, company, favorite, created_at, updated_at, version)
VALUES ('John', 'Smith', 'john.smith@example.com', '+44 20 7946 0958', 'Globex Corp', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

INSERT INTO contacts (first_name, last_name, email, phone, company, favorite, created_at, updated_at, version)
VALUES ('Maria', 'Garcia', 'maria.garcia@example.com', NULL, 'Initech', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
